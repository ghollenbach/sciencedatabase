    ...
    <div className="dashboard">
      <header className="dashboard-header">
        <div className="dashboard-header__content">
          <h1 className="dashboard-title">Science Department Inventory</h1>
          <ProfileDropdown />
        </div>
      </header>
          ...
          <div className="add-form">
            ...
            <div className="form-actions">
              <button
                type="button"
                className="secondary"
                onClick={() => setRequestMoreModal({ isOpen: false, itemId: null, itemName: '', quantity: '', requesterName: '' })}
              >
                Cancel
              </button>
              <button
